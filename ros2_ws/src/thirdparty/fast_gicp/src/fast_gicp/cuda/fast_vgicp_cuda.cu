// Workaround for CUDA 12.x thrust::pair ambiguity with libstdc++ <tuple>
// Must appear before ANY other include.
#include <thrust/detail/config.h>
#undef THRUST_NAMESPACE_BEGIN
#undef THRUST_NAMESPACE_END
