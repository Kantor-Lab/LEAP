...
def launch_setup(context, *args, **kwargs):
    ...
    config_file = LaunchConfig('config_yaml').perform(context)
    calib_url = LaunchConfig('calib_url').perform(context)
    ...
    if not config_file:
        config_file = example_parameters[camera_type]
    ...
    return LaunchDescription(
        [
            ...
            LaunchArg(
                'config_yaml',
                default_value='',
                description='path to ros parameters of camera settings'
            ),
            LaunchArg(
                'calib_url',
                default_value='',
                description='url to intrinsic calibration parameters'
            ),
